...
public class Damas {
    public static void main(String[] args) {
        ...
        while(true){
	      ...
	      /* Para estar mesma diagonal: as somas dos indices x e y precisam ser iguais nas duas posições (diagonal 1)
	    	   ou as diferenças dos indices x e y precisam ser iguais nas duas posições (diagonal 2)
	    	*/
